                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: _isCaptured ? AppTheme.primaryColor : Colors.white.withOpacity(0.3),
                            ),
                            child: _isCaptured ? const Icon(Icons.check, color: Colors.white, size: 32) : const Icon(Icons.camera_alt, color: Colors.white),
                          ),
                        ),
                        const SizedBox(width: 30),
